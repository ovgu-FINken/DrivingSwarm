...
tmux send-keys -t turtlebots:0 "roslaunch turtlebot3_gazebo multi_turtlebot3.launch" C-m
sleep 5
...
tmux send-keys -t turtlebots:4 "ROS_NAMESPACE=tb3_0 roslaunch tracking_certainty_grid tracking_simulation.launch" C-m
