...
class BehaviourAServer:
    ...
    def execute(self, goal):
        ...
        if goal.goal_name not in self.actions:
        ...
        try:
            rospy.wait_for_service(self.actions[goal.goal_name], timeout=self.srv_timeout)
        ...
        behav_service = rospy.ServiceProxy(self.actions[goal.goal_name]), eval(goal.goal_name).srv.eval(self.actions[goal.goal_name])
